        ...
        function r(e, r) {
          for (var a = {}, c = [], i = 0; i < e.length; i++) {
            ...
            if (-1 !== p) t[p].references++, t[p].updater(f)
              ...
              var v = o(f, r)
              ;(r.byIndex = i), t.splice(i, 0, { identifier: d, updater: v, references: 1 })
            }
            c.push(d)
          }
          return c
  ...
  ;(n.n = e => {
    ...
    (() => {
      var e = n(379),
        ...
        f = n(648),
        v = {}
      ;(v.styleTagTransform = p()), (v.setAttributes = s()), (v.insert = c().bind(null, 'head')), (v.domAPI = o()), (v.insertStyleElement = l()), t()(f.Z, v), f.Z && f.Z.locals && f.Z.locals
      var m = n(567),
        h = {}
      ;(h.styleTagTransform = p()), (h.setAttributes = s()), (h.insert = c().bind(null, 'head')), (h.domAPI = o()), (h.insertStyleElement = l()), t()(m.Z, h), m.Z && m.Z.locals && m.Z.locals
      const y = n.p + 'a_91bf56d7f495b6dc9c5d.png',
        b = document.createElement('img')
      ;(b.src = y), document.body.appendChild(b)
      const g = document.createElement('div')
      ;(g.textContent = '我是创建的div'), g.classList.add('content'), document.body.appendChild(g)
      const x = document.createElement('h2')
      ;(x.innerHTML = '哈哈哈哈，我是h2'), (x.className = 'title'), document.body.appendChild(x), console.log('zds')
    })()
})()
